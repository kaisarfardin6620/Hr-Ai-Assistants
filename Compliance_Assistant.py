...
compliance_prompt = prompts["COMPLIANCE"]
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        answer = ask_compliance_assistant(user_input)
        print("Compliance Assistant:", answer)
    else:
        while True:
            try:
                question = input("Ask the Compliance Assistant (or type 'exit' to quit): ")
                if question.lower() == "exit":
                    break
                ask_compliance_assistant(question)
