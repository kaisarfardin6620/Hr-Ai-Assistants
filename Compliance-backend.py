...
def load_prompt(filepath="prompts.json", prompt_key="COMPLIANCE"):
...
def get_compliance_response(user_input: str, user_id: str = None, prompt_file: str = "prompts.json") -> dict:
    """
    ...
    # Load system prompt
    try:
        compliance_prompt = load_prompt(prompt_file, "COMPLIANCE")
    except RuntimeError:
